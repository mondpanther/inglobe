...
getwd()
library(fst)
countrymap <- read_fst("../iseapp/countrymap.fst")
#for (ff in files) {
...
istraxglobal= read_fst("../iseapp/istraxes/istrax_global.fst")
istraxemdeexcn= read_fst("../iseapp/istraxes/istrax_emdenocn.fst")
istraxnational= read_fst("../iseapp/istraxes/istrax_nationalkey_2009_2018.fst")
evglobal=read_fst("../iseapp/istraxes/ev_global.fst")
